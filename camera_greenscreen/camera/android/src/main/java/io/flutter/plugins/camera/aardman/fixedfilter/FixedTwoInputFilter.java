...
public class FixedTwoInputFilter extends FixedBaseFilter {
    ...
    public FixedTwoInputFilter(String fragmentShader) {
        this(VERTEX_SHADER, fragmentShader);
    }

    public FixedTwoInputFilter(String vertexShader, String fragmentShader) {
